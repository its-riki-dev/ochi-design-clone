...
const Footer = () => {
    return (
        <div data-scroll data-scroll-speed="0.11" className='flex gap-5 w-full h-screen text-black bg-[#CDEA68] px-[60px] py-15'>
            <div className='w-1/2 h-full flex flex-col justify-between font-["FoundersGrotesk"]'>
                <div>
                    <h1 className='text-[9vw] -mb-9 uppercase leading-none'>Eye-</h1>
                    <h1 className='text-[9vw] -mb-7 uppercase leading-none'>Opening</h1>
                </div>

                <div className="logo cursor-pointer mt-110">
            ...
            <div className='w-1/2 h-full flex flex-col justify-between text-sm'>
                <h1 className='text-[9vw] -mb-7 uppercase leading-none tracking-tight font-["FoundersGrotesk"]'>Presentations</h1>

                <div className='grid grid-cols-2 gap-10 mt-10 text-[17px] font-["NeueMontreal"]'>

                    <div>
                        <div>
                            <h4 className='mb-5'>S:</h4>
                            <ul className='space-y-1 underline leading-[18px] tracking-wider'>
                        ...
                        <div className='cursor-pointer mt-10'>
                            ...
                            leading-[18px] tracking-wider'>
                                <li>202-1965 W 4th Ave</li>
                                <li>Vancouver, Canada</li>
                                <li className='mt-9'>30 Chukarina St</li>
                                <li>Lviv, Ukraine</li>
                            </ul>
                        </div>
                        ...
                        <div className='cursor-pointer mt-10'>
                            ...
                            <p className='underline leading-[18px] tracking-wider'>hello@ochi.design</p>
                        </div>
                    </div>

                    <div className='ml-50'>
                        <h4 className='mt-45 mb-5'>M:</h4>
                        <ul className='leading-[18px]tracking-wider underline'>
                            <li><a href="#">Home</a></li>
                ...
                <div className='flex justify-between mt-18 text-zinc-600 text-[17px] font-["NeueMontreal"]'>
                    <p>© ochi design 2025. <span className='underline cursor-pointer'>Legal Terms</span></p>
                    <p className='text-right'><span>Clone of</span> <a className='underline cursor-pointer' href="https://ochi.design/">Obys</a></p>
                </div>
            </div>
        </div>
    )
